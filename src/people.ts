...
export const peopleData: PersonData[] = [
  ...
  },
  {
    ...
    content: {
      de: 'Aufgewachsen im Leipziger Umland begeisterte ich mich bereits in meiner Jugend für die Möglichkeiten, die Softwareentwicklung und Digitalisierung bieten. Mein Diplom im Bereich Informatik erwarb ich 2011 an der Berufsakademie Leipzig. Seit mehr als 10 Jahren betreue ich als Entwickler, Software Architekt, Ausbilder und Scrum Master digitale Projekte. Durch Freunde erfuhr ich 2018 vom Kulturhackathon Coding da Vinci, in dessen Rahmen ich meine Fähigkeiten in einem kreativen und vielseitigen Umfeld erweitern und ausprobieren konnte. Gemeinsam mit Anne entwickle ich diese Erfahrungen und Ansätze ständig weiter und mache sie so für zukünftige Projekte nutzbar - dafür gibt es das Digitalwarenkombinat. Ich präsentiere unsere Projekte regelmäßig auf internationalen Konferenzen und Tagungen. Darüber hinaus bin ich als Anwendungsentwickler in einer Leipziger Bibliothek tätig.',
